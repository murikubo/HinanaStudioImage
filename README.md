...
Windows x64에서는 `release/Hinana-Studio-Image-0.8.0-Windows-x64-Setup.exe`로 설치합니다. 설치 위치를 선택할 수 있고, 시작 메뉴/바탕화면 바로가기를 만듭니다.
...
- HEIC/TIFF, LUT 기반 ICC 고정밀 입력, 부분 마스크, 자유 영역 자르기, 렌즈 보정, 일괄 내보내기는 미지원입니다.
